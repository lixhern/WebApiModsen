...
function cbcDecrypt(enc, cek, ciphertext, iv, tag2, aad) {
  return __async(this, null, function* () {
    ...
    let plaintext;
    try {
      plaintext = new Uint8Array(yield webcrypto_default.subtle.decrypt({
        iv,
        name: "AES-CBC"
      }, encKey, ciphertext));
    } catch {
...
var decrypt = (enc, cek, ciphertext, iv, tag2, aad) => __async(void 0, null, function* () {
...
var importAndCache = (cache, key, jwk, alg) => __async(void 0, null, function* () {
...
function cbcEncrypt(enc, plaintext, cek, iv, aad) {
  return __async(this, null, function* () {
    ...
    const macData = concat(aad, iv, ciphertext, uint64be(aad.length << 3));
    const tag2 = new Uint8Array((yield webcrypto_default.subtle.sign("HMAC", macKey, macData)).slice(0, keySize >> 3));
    return {
      ciphertext,
      tag: tag2,
      iv
...
var keyToJWK = (key) => __async(void 0, null, function* () {
  ...
  const _a = yield webcrypto_default.subtle.exportKey("jwk", key), {
    ext,
    key_ops,
    alg,
    use
